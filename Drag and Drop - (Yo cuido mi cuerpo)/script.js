document.addEventListener("DOMContentLoaded", function () {
    ...
    const itemsSection1 = [
        { id: 'Bañarse-drop', pair: 'BAÑARSE', src: 'Images/BAÑARSE.gif' },
        { id: 'Caer-drop', pair: 'CAER', src: 'Images/CAER.gif' },
        { id: 'Comer-drop', pair: 'COMER', src: 'Images/COMER.gif' },
        { id: 'Descansar-drop', pair: 'DESCANSAR', src: 'Images/DESCANSAR.gif' },
        { id: 'Doctor-drop', pair: 'DOCTOR', src: 'Images/DOCTOR.gif' }
    ];

    const itemsSection2 = [
        { id: 'Dolor_de_cabeza-drop', pair: 'DOLOR_DE_CABEZA', src: 'Images/DOLOR DE CABEZA.gif' },
        { id: 'Dolor_de_estomago-drop', pair: 'DOLOR_DE_ESTOMAGO', src: 'Images/DOLOR DE ESTOMAGO.gif' },
        { id: 'Ejercicio-drop', pair: 'EJERCICIO', src: 'Images/EJERCICIO.gif' },
        { id: 'Jabon-drop', pair: 'JABON', src: 'Images/JABON.gif' },
        { id: 'Medicina-drop', pair: 'MEDICINA', src: 'Images/MEDICINA.gif' }
    ];
