...
function initializeGame() {
    ...
    const itemsSection1 = [
        { id: 'Animales-drop', pair: 'ANIMALES', src: 'img/ANIMALES.gif' },
        { id: 'Caballo-drop', pair: 'CABALLO', src: 'img/CABALLO.gif' },
        { id: 'Elefante-drop', pair: 'ELEFANTE', src: 'img/ELEFANTE.gif' },
        { id: 'Gato-drop', pair: 'GATO', src: 'img/GATO.gif' },
        { id: 'Leon-drop', pair: 'LEON', src: 'img/LEÓN.gif' }
    ];

    const itemsSection2 = [
        { id: 'Pajaro-drop', pair: 'PAJARO', src: 'img/PÁJARO.gif' },
        { id: 'Pato-drop', pair: 'PATO', src: 'img/PATO.gif' },
        { id: 'Perro-drop', pair: 'PERRO', src: 'img/PERRO.gif' },
        { id: 'Pez-drop', pair: 'PEZ', src: 'img/PEZ.gif' },
        { id: 'Vaca-drop', pair: 'VACA', src: 'img/VACA.gif' }
    ];
